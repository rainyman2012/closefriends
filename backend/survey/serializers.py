...
from .models import Question, Choice, Survey, Answer, Target
...
class QuestionSerializer(serializers.ModelSerializer):
    ...
    target = serializers.StringRelatedField(many=True)

    class Meta:
        model = Question
        fields = ('id', 'choices', 'name', 'ask', 'sex', 'analyze', 'target')
...
class SurveySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'answer_set', 'questions', 'name',
                  'uuid', 'realAnswers', 'lang', 'sex', 'user', 'target')
